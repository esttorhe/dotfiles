# Requirements Archive: v1.0 Working Baseline
...
- [x] **POLISH-02**: Fortune/habits integration on shell start (added post-v1)
- [x] **POLISH-03**: Custom clear with fortune (Ctrl+L) (added post-v1, has limitation)
...
**Adjusted:** POLISH-02, POLISH-03 added post-v1 planning (implemented same day)
**Dropped:** None
